...
struct HomeViewThreeView: View {
    @StateObject var homeViewThreeViewModel = HomeViewThreeViewModel()
                    ...
                    VStack {
                            ...
                            HStack {
                                HStack {
                                    ...
                                    TextField(StringConstants.kLblSearch,
                                              text: $homeViewThreeViewModel.input)
                                        .font(FontScheme
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            Text(StringConstants.kLblFavorites)
                                ...
                                .padding(.trailing)
                            Image("img_items_amber_100_64X343")
                                .resizable()
                                ...
                                ScrollView(.vertical, showsIndicators: false) {
                                    LazyVStack {
                                        ForEach(0 ... 4, id: \.self) { index in
                                            ListCard1Cell()
                                                .onTapGesture {
                                                    homeViewThreeViewModel.nextScreen = "EventView"
                                                }
                                        }
                                    }
                                }
                        ...
                        .frame(width: getRelativeWidth(343.0), height: getRelativeHeight(800.0),
                               alignment: .center)
...
//                                   tag: "EventView",
//                                   selection: $homeViewThreeViewModel.nextScreen,
//                                   label: {
//                                       EmptyView()
//                                   })
...
struct HomeViewThreeView_Previews: PreviewProvider {
