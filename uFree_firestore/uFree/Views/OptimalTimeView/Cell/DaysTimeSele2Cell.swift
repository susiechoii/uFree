...
struct DaysTimeSele2Cell: View {
    ...
    init(index: Int, defaultHours: [Int]) {
        self.index = index
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: true){
            ...
            .onAppear{
                didTapRow0 = viewModel.savedUserDefaultHours.contains(index*24+0)
                didTapRow1 = viewModel.savedUserDefaultHours.contains(index*24+1)
                didTapRow2 = viewModel.savedUserDefaultHours.contains(index*24+2)
                didTapRow3 = viewModel.savedUserDefaultHours.contains(index*24+3)
                didTapRow4 = viewModel.savedUserDefaultHours.contains(index*24+4)
                didTapRow5 = viewModel.savedUserDefaultHours.contains(index*24+5)
                didTapRow6 = viewModel.savedUserDefaultHours.contains(index*24+6)
                didTapRow7 = viewModel.savedUserDefaultHours.contains(index*24+7)
                didTapRow8 = viewModel.savedUserDefaultHours.contains(index*24+8)
                didTapRow9 = viewModel.savedUserDefaultHours.contains(index*24+9)
                didTapRow10 = viewModel.savedUserDefaultHours.contains(index*24+10)
                didTapRow11 = viewModel.savedUserDefaultHours.contains(index*24+11)
                didTapRow12 = viewModel.savedUserDefaultHours.contains(index*24+12)
                didTapRow13 = viewModel.savedUserDefaultHours.contains(index*24+13)
                didTapRow14 = viewModel.savedUserDefaultHours.contains(index*24+14)
                didTapRow15 = viewModel.savedUserDefaultHours.contains(index*24+15)
                didTapRow16 = viewModel.savedUserDefaultHours.contains(index*24+16)
                didTapRow17 = viewModel.savedUserDefaultHours.contains(index*24+17)
                didTapRow18 = viewModel.savedUserDefaultHours.contains(index*24+18)
                didTapRow19 = viewModel.savedUserDefaultHours.contains(index*24+19)
                didTapRow20 = viewModel.savedUserDefaultHours.contains(index*24+20)
                didTapRow21 = viewModel.savedUserDefaultHours.contains(index*24+21)
                didTapRow22 = viewModel.savedUserDefaultHours.contains(index*24+22)
                didTapRow23 = viewModel.savedUserDefaultHours.contains(index*24+23)
            }
        }
    }
}
...
struct DaysTimeSele2Cell_Previews: PreviewProvider {
 ...
 static var previews: some View {
     DaysTimeSele2Cell(index: 0, defaultHours: [0]).environmentObject(AuthenticationViewModel())
 }
 }
