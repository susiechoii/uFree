...
struct Stackrectanglenineone1Cell: View {
    var body: some View {
        ZStack(alignment: .leading) {
            ZStack {}
                .hideNavigationBar()
                .frame(width: getRelativeWidth(298.0), height: getRelativeHeight(24.0),
                       alignment: .leading)
...
/* struct Stackrectanglenineone1Cell_Previews: PreviewProvider {
